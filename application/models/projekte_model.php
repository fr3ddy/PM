...
AND Plan.ProjektID = ProjektAmort.ID");
        ...
        foreach ($query->result() as $row) {
            if (isset($data[$row -> BereichsID])) {
                $data[$row -> BereichsID]["Bereichsinformationen"]["Gewinn"] = $data[$row -> BereichsID]["Bereichsinformationen"]["Gewinn"] + $row -> Gewinn;
                $data[$row -> BereichsID]["Bereichsinformationen"]["Kosten"] = $data[$row -> BereichsID]["Bereichsinformationen"]["Kosten"] + $this -> gibGesamtKosten($row -> ProjektID);
            } else {
                $data[$row -> BereichsID]["Bereichsinformationen"]["Gewinn"] = $row -> Gewinn;
